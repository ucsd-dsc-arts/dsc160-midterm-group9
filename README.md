...
Interactive plots showing these in greater detail can be found at the "Make Interactive Plots" section of the [visualization notebook](code/visualization.ipynb).
